...
local function main()
    ...
    local function default_cfg()
        return {
            ...
            body_yaw  = "Jitter", body_amount = 60,
    ...
    local function persist()
        ...
        for _, s in ipairs(CONDS) do
            ...
            f[s.."|ba"], f[s.."|fs"], f[s.."|ed"] = c.body_amount, c.freestand, c.edge_yaw
        end
    ...
    local function restore()
        ...
        for _, s in ipairs(CONDS) do
            ...
            if f[s.."|ba"] then c.body_amount = tonumber(f[s.."|ba"]) or c.body_amount end
    ...
    local w_bamt = ui.new_slider("LUA", "B", "\aFFFFFFFF  Desync amount", 0, 60, 60)
    ...
    local elems = { w_en, w_yb, w_yo, w_ym, w_ya, w_ys, w_yi, w_pm, w_pa, w_ps, w_pi, w_body, w_bamt, w_free, w_edge }
    ...
    local function load_focused()
        ...
        ui.set(w_body, c.body_yaw); ui.set(w_bamt, c.body_amount)
    ...
    local function save_focused()
        ...
        c.body_yaw = ui.get(w_body); c.body_amount = ui.get(w_bamt)
    ...
    local function apply(c)
        ...
        if c.body_yaw == "Off" then
            ...
            setref(r_body_val, c.body_amount)
        end
    ...
    local function on_paint_ui()
        ...
        renderer.text(sx / 2, sy * 0.62, 180, 190, 255, 255, "c", 0,
            string.format("AA builder  [%s]  yaw %.0f", hud.cond, hud.yaw))
    end
