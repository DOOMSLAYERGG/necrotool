...
local function draw_intro_animation()
    ...
    local glow_layers = 11
    local glow_spread = 1.15 + 0.35 * pulse                  -- smaller, breathing reach
    local glow_th = glow_spread + 1.2
    local halo_a = (105 + 85 * pulse) * fade                 -- clearly visible
